    ...
    <div className="booking-system-form">
      <form className={bookingStyle} onSubmit={handleSubmit}>
        <div className="select">
          ...
          >
            <option value={inputs.option || "1"}>1 Person</option>
            <option value={inputs.option || "2"}>2 Persons</option>
            <option value={inputs.option || "3"}>3 Persons</option>
            <option value={inputs.option || "4"}>4 Persons</option>
            <option value={inputs.option || "5"}>5 Persons</option>
            <option value={inputs.option || "6"}>6 Persons</option>
            <option value={inputs.option || "7"}>7 Persons</option>
            <option value={inputs.option || "8"}>8 Persons</option>
            <option value={inputs.option || "9"}>9 Persons</option>
            <option value={inputs.option || "10"}>10 Persons</option>
          </select>
        ...
        {/* New Inputs for Fullname, Email, and Phone */}
        <div>
