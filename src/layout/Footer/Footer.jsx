...
const Footertext = {
  ...
  phoneone: "+212675480018",
  phonetwo: "1-800-915-6271",
  addressone: "Av. Echouhada",
  addresstwo: " Rue Ahmed Chawqui Hivernage1",
  timeone: "Every Day: 07:00PM - 02:00AM",
          ...
          <div className="footer-main">
            <div className="footer-eamil-menu">
              <div className="footer-email">
                <a href="mailto:reservation@le-palacemarrakech.com">
                  {Footertext.email}
                </a>
              </div>
